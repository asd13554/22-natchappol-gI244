...
public class UnitCommand : MonoBehaviour
{
    ...
    private void TryCommand(Vector2 screenPos) 
    {
        ...
        if (Physics.Raycast(ray, out hit, 1000, layerMask))
        {
            ...
            {
                case "Ground": CommandToGround(hit, unitSelect.CurUnits); 
                    break;
                case "Resource": ResourceCommand(hit, unitSelect.CurUnits); 
                    break;
                case "Unit": CommandToUnit(hit, unitSelect.CurUnits); 
                    break;
                case "Building": BuildingCommand(hit, unitSelect.CurUnits); 
                    break;
            }
        } 
    }
